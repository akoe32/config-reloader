...
// +kubebuilder:rbac:groups=operation.sendentembok.org,resources=configreloaders,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=operation.sendentembok.org,resources=configreloaders/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=operation.sendentembok.org,resources=configreloaders/finalizers,verbs=update
...
func (r *ConfigReloaderReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&operationv1.ConfigReloader{}).
